        ...
        public virtual OrdersDeliveryGoodsInfo GetOrdersDeliveryGoodsByID(int ID)
        {
            ...
            try
            {
                ...
                if (RdrList.Read())
                {
                    ...
                    entity.Orders_Delivery_Goods_ProductAmount = Tools.NullInt(RdrList["Orders_Delivery_Goods_ProductAmount"]);
                    entity.Orders_Delivery_Goods_ReceivedAmount = Tools.NullInt(RdrList["Orders_Delivery_Goods_ReceivedAmount"]);
