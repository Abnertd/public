...
namespace Glaer.Trade.B2C.Model
{
    ...
    public class OrdersDeliveryGoodsInfo
    {
        ...
        private double _Orders_Delivery_Goods_ProductAmount;
        private double _Orders_Delivery_Goods_ReceivedAmount;
        ...
        public double Orders_Delivery_Goods_ProductAmount
        {
            get { return _Orders_Delivery_Goods_ProductAmount; }
            set { _Orders_Delivery_Goods_ProductAmount = value; }
        }

        public double Orders_Delivery_Goods_ReceivedAmount
        {
