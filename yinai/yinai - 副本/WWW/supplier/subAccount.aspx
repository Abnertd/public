...
<head>
    <title><%="创建子账户 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a><strong>创建子账户</strong></div>
            <!--位置说明 结束-->
        </div>
        <div class="partd_1">
            <div class="pd_left">
            ...
            <div class="pd_right">
                <div class="blk14_1" style="margin-top: 0px;">
                    ...
                    <div class="b14_1_main" style="margin-top: 15px;">
                        ...
                        <%}%>
                        <form name="frm_account_profile" id="frm_account_profile" method="post" action="/supplier/account_do.aspx" onsubmit="return check_supplier_nickname('Supplier_SubAccount_Name');">
