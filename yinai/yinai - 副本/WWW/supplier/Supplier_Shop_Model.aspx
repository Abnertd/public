...
<% 
    ...
    Addr addr = new Addr();
    supplier.Supplier_Login_Check("/supplier/Supplier_Shop_Model.aspx");
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a> <strong>模板管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">                  
                    <% supplier.Get_Supplier_Left_HTML(2, 2); %>                
                </div>
                <div class="pd_right">
                    ...
                    <div class="blk17_sz">
                        ...
                        <form name="formadd" id="formadd" method="post" action="/supplier/account_do.aspx" onsubmit="javascript:MM_findObj('Shop_CateID').value = tree.getAllChecked();">
                            ...
                            <table border="0" cellspacing="0" cellpadding="5" id="apply_3_content">
                                <%=supplier.Display_Shop_Css(entity.Shop_Css,entity.Shop_Type)%>
                            </table>

                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td align="center" height="50">
                                        <input name="action" type="hidden" id="action" value="shop_set_model" />
