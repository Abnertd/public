...
<% 
    ...
    supplier.Supplier_Login_Check("/member/bid_Attachments_add.aspx?BID=" + BID);
...
<head>
    ...
    <title><%="添加附件 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/supplier/index.aspx">商家中心</a> > <a href="/supplier/auction_list.aspx">拍卖列表</a> ><span>添加附件</span></div>
            <div class="partd_1">
                <div class="pd_left">
                    ...
                    <div class="blk02">
                        ...
                        <div class="b02_main">
                            <ul style="width:850px;">
                               <%-- <li><span><i>*</i>
                                    序号：</span>
                                    <label><input name="Bid_Attachments_Sort" id="Bid_Attachments_Sort" type="text" style="width: 298px;" value="1" /></label></li>
                                <div class="clear"></div>--%>
