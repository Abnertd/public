...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/supplier/index.aspx">我是卖家</a> > <strong>资料管理</strong></div>
            <!--位置说明 结束-->

            <div class="partd_1">
                <div class="pd_left">
                  <%--  <% =member.Member_Left_HTML(3, 1) %>--%>
                ...
                <div class="pd_right">
                    <div class="blk14_1" style="margin-top: 0px;">
                        ...
                        %>
                        <h2><span><a href="/supplier/account_profile_edit.aspx" class="a13" style="float: right; margin-right: 15px; color: #ffffff; font-weight: normal; font-size: 12px;">修改</a></span>账户信息</h2>
...
<%--                                            <tr>
                                    ...
                                    <input type="radio" id="Supplier_SaleType2" name="Supplier_SaleType" value="1" <%=pub.CheckedRadio(supplierinfo.Supplier_SaleType.ToString(), "1")%> />代销
                                            ...
                                            <tr>
                                                ...
                                                <td><span id="Span1" name="Member_NickName">
                                                    <%=memberInfo.Member_NickName%></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span id="Member_RealName" name="Member_RealName">
