...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Supplier_Shop_Pages_Add.aspx");
...
<head>
    <title><%="店铺栏目添加 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a><strong>栏目管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">
                    <% supplier.Get_Supplier_Left_HTML(2, 4); %>
                </div>
                <div class="pd_right">
                            ...
                            <form name="formadd" id="formadd" method="post" action="/supplier/Supplier_Shop_Pages_do.aspx">
                                <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Shop_Pages_Title" type="text" id="Shop_Pages_Title" style="width: 300px; background: none" class="input01" value="" /><i>*</i>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="801">
                                            <textarea cols="80" id="Shop_Pages_Content" name="Shop_Pages_Content" rows="16"></textarea>
                                            <script type="text/javascript">
                                    ...
                                    <tr>
                                        <td width="92" class="name">排序
                                        </td>
                                        <td width="801">
                                            <input name="Shop_Pages_Sort" type="text" id="Shop_Pages_Sort" style="width: 300px; background: none" class="input01" maxlength="10" value="0" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" />
