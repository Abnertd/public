...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Supplier_Security_Account_list.aspx");
    ...
    if (supplierinfo != null)
    {
        ...
        //if (supplierinfo.Supplier_Cert_Status != 1)
        //{
...
<head>
    <title><%="保证金管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->         
        <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a> <strong>保证金管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">               
                ...
                <div class="pd_right">  
                    <div class="blk14_1" style="margin-top:0px;">
                      <h2><span><a href="/supplier/supplier_margin_account_Recharge.aspx" class="a13" style="float:right;margin-right:15px;color:#ffffff;font-weight:normal;font-size:12px;">充值保证金</a></span>保证金管理</h2>
                         <%--<h2>保证金管理</h2>--%>
                       <%--<div style="margin-top:15px; margin-left:10px; font-size:14px;">保证金余额：<span style="font-size:18px;color:#ff6600;padding:4px 0 4px 4px; "><%=pub.FormatCurrency(Supplier_Account) %></span></div>--%> 

                    <div class="b14_1_main" style="margin-top: 15px;">
                        <%supplier.Get_Account_Log_List(1, action, date_start, date_end); %>
                    </div>
                </div>   </div>
            </div>
        </div>
