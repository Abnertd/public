...
<head>
    <title><%="产品管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content02" style="background-color: #FFF;">
         ...
         <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a> <strong>商品管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">                
                        <%supplier.Get_Supplier_Left_HTML(3, 2); %>                 
                </div>

                <div class="pd_right">
                   <div class="blk14_1" style="margin-top:0px;">
                 <%--   <div class="title03">商品管理</div>--%>
                       <h2>商品管理</h2>
                   <%supplier.Supplier_Product_List("product");%>
                </div>
