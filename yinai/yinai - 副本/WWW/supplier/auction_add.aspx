...
<% 
    ...
    string Supplier_Company = string.Empty;
    double Supplier_Account;
    Supplier_Account = 0;
    SupplierInfo supplierinfo = supplier.GetSupplierByID();
    if (supplierinfo != null)
    {
        Supplier_Company = supplierinfo.Supplier_CompanyName;
                        ...
                        <form name="frm_bid" id="frm_bid" method="post" action="/supplier/auction_do.aspx">
                            <div class="b02_main">
                                <ul style="width: 850px;">
                                    ...
                                    <div class="clear"></div>
                                    <li><span><i>*</i>拍卖用户：</span><label><input name="Bid_MemberCompany" id="Bid_MemberCompany" type="text" style="width: 298px;" value="<%=Supplier_Company %>" /></label></li>
                                    <div class="clear"></div>
