...
<head>
    <title><%="投标添加 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 投标管理 > <strong>添加投标</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">
                    ...
                    <div class="blk02">
                        ...
                        <div class="b14_1_main" id="aa01" style="border: 0px solid #dddddd; display: none;">
                            ...
                            <div class="blk11_1" style="margin-top: 20px;padding:0 0 10px 0;">
                                <h2 style="font-size:15px;font-weight:bold;">商品清单</h2>
                            ...
                            <div class="blk11_1" style="margin-top: 20px;padding:0 0 10px 0;">
                                <h2 style="font-size:15px;font-weight:bold;">附件列表</h3>
                                <table width="975" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #eeeeee;">
                                <tr>
                                  <%--  <td width="120" class="name">物料编号</td>--%>
                                    <td width="180" class="name">附件名称</td>   
                                    <td width="180" class="name">说明</td>
                                  <%--  <td width="180" class="name">品牌</td>--%>
                                    <td width="180" class="name">操作</td>
                                    <%--<td width="180" class="name">采购数量</td>--%>
                                </tr>
