...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/tender_sign.aspx");
    Bid MyBid = new Bid();
    ...
    if (supplierinfo != null)
    {
        ...
        //if (tools.NullInt(supplierinfo.Supplier_IsHaveShop) == 0)
        {
...
<head>
    <title><%="报名列表 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a><strong>报名列表</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">

                    <% supplier.Get_Supplier_Left_HTML(6,2); %>
                </div>
                <div class="pc_right">
