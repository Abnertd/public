...
<% 
    ...
    string Product_CateID, Product_Code, Product_Name, Product_GroupID, Product_Spec;
    ...
    Product_Spec = tools.CheckStr(Request.Form["Product_Spec"]);
                            ...
                            <form name="formadd" id="formadd" method="post" action="/supplier/product_do.aspx">
                                ...
                                <div class="b07_main_sz" id="apply_1_content">
                                    <div class="b07_info04_sz" style="display: normal; margin-left: 50px">
                                        ...
                                        <table width="793" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="Product_Spec" type="text" id="Product_Spec" style="width: 300px;" class="input01" value="<%=Product_Spec %>" /><i>原料类请填写粒度。如大块8-15，200目等；<br />
                                                        设备等辅助物资请填写型号</i></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td id="selected_Unit">
                                                    ...
                                                    <i>请按照商品的实际情况填写 吨，块<br/>袋，台，kg等</i>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="Product_Weight" type="text" id="Product_Weight" style="width: 300px;" value="0" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" class="input01" onblur="GetProductPrice();" />
                                                    (单位:<span id="Product_Unit_Name_weight"></span>)
                                                    <i>请按照商品的实际情况填写（选填）</i>
                                    ...
                                    <div class="b07_main" style="display: normal; margin-left: 90px">
                                        <span style="font-size: 18px; color: #ff6600">商品指标</span>
