...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Supplier_Account_list.aspx");
...
<body>
    ...
    <div class="content">
        <!--位置说明 开始-->
        <div class="position">
            您现在的位置 > <a href="/">首页</a> > <a href="index.aspx">会员中心</a> > <a href="supplier_account_list.aspx">
                现金账户</a>
        </div>
        <div class="clear">
        </div>
        ...
        <div class="parth">
            <div class="ph_left">
                <% supplier.Get_Supplier_Left_HTML(8, 3); %>
            </div>
            <div class="ph_right">
                <div class="blk13">
                    <h2>
                    ...
                    <div class="main">
                        <div class="zkw_order">
                            <p style="margin-bottom: 10px;">
                                现金余额：<b style="color: #c00; font-family: Verdana;"><%=pub.FormatCurrency(Supplier_Account)%></b></p>
                            <h3 class="zkw_title21">
                                <%
                                    StringBuilder strHTML = new StringBuilder();
                                    strHTML.Append("<ul class=\"zkw_lst31\">");
                                    strHTML.Append("	<li " + (Session["account_coin_list_guide"] == "today" ? "class=\"on\"" : "") + " id=\"n01\"><a href=\"supplier_account_list.aspx\">今日明细</a></li>");
                                    strHTML.Append("	<li " + (Session["account_coin_list_guide"] == "history" ? "class=\"on\"" : "") + " id=\"n02\"><a href=\"supplier_account_list.aspx?action=history\">历史明细</a></li>");
                            ...
                            <div class="zkw_19_fox" id="nn01">
                                <%
                                    ...
                                    {%>
                                <form name="datescope" method="post" action="/supplier/Supplier_Account_list.aspx?action=history">
                                <div class="zkw_date">
                                ...
                                <%supplier.Get_Account_Log_List(0, action, date_start, date_end); %>
