...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/subAccount_edit.aspx");
...
<head>
    <title>
        <%="修改子账户 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content02" style="background-color: #FFF;">
       <%-- <div class="content02_main" style="background-color: #FFF;">--%>
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 账户管理 > <strong>修改子账户</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
            <div class="pd_left">
