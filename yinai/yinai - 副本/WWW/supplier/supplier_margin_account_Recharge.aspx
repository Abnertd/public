...
<% 
    ...
    supplier.Supplier_AuditLogin_Check("/supplier/supplier_margin_account_Recharge.aspx");
                        ...
                        <div class="blk17_sz">
                            <form name="frm_account_profile" id="frm_account_profile" method="post" action="/supplier/account_do.aspx">
                                <table width="100%" border="0" cellspacing="0" cellpadding="5" class="table_padding_5">
                                    <tr>
                                        <td width="92" class="name">保证金金额
                                        </td>                                    
                                          <td width="801">
                                           <%-- <input name="Account_Amount" type="text" class="txt_border" id="Account_Amount"
                                                size="40" maxlength="20" readonly="readonly" value="<%=entity.Supplier_Margin_Amount %>" />
                                            元--%>
                                               <input name="Account_Amount" type="text" class="txt_border" id="Account_Amount"
                                                size="40" maxlength="20" readonly="readonly" value="0.1" />
                                            元
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td width="92" class="name">支付方式：
                                        </td>
                                        <td width="801">
                                            <input type="radio" name="pay_type" value="ECITIC" checked="checked" style="margin-top: 10px; float: left; margin-right: 11px; display: inline-block; vertical-align: middle; padding: 0; border: none; -webkit-box-shadow: none;" /><img alt="中信银行" title="中信银行" src="/images/zhongxinyinhang.jpg" width="110" height="35" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="table_v_title">
                                                <input name="action" type="hidden" id="action" value="account_add_new" />
