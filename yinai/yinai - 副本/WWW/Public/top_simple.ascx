...
<%
    ...
    Glaer.Trade.B2C.Model.SupplierInfo supplierinfoDomain = supplier.GetSupplierByID();
    string Shop_Domain = "";
    Glaer.Trade.B2C.BLL.MEM.ISupplierShop MyShop = Glaer.Trade.B2C.BLL.MEM.SupplierShopFactory.CreateSupplierShop();
    Public_Class pub = new Public_Class();
    if (supplierinfoDomain != null)
    {
        Glaer.Trade.B2C.Model.SupplierShopInfo shopinfos = MyShop.GetSupplierShopBySupplierID(supplierinfoDomain.Supplier_ID);
        if (shopinfos != null)
        {
        ...
        <div class="top_main">
            <div class="top_main_right">
                <ul>
                    ...
                    <%} %>
                    <li class="li03">
                        <a href="<%=Shop_Domain%>"" target="_blank">我的店铺</a>
                    </li>
