...
<% 
    ...
    supplier.Supplier_AuditLogin_Check("/valuate/supplier_shopevaluate.aspx");
%>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/supplier/index.aspx">我是卖家</a> > <span>店铺评论</span></div>
            <div class="partd_1">
                <div class="pd_left">
                ...
                <div class="pd_right">
                    <div class="blk14_1" style="margin-top: 1px;">
                        <h2>我的店铺评论</h2>
                        <%myproduct.shopsuppliervaluate(1); %>
                    </div>
