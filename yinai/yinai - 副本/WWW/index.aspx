                ...
                <div class="pa_left">
                    ...
                    <div class="banner" style="height: 320px; overflow: hidden;">
                        ...
                        <script type="text/javascript">
                            ...
                            function changeflash(i) {
                                currentindex = i;
                                for (j = 1; j <= 5; j++) {//此处的5代表你想要添加的幻灯片的数量与下面的4相呼应
                                    if (j == i) {
                            ...
                            function timer_tick() {
                                currentindex = currentindex >= 4 ? 1 : currentindex + 1;//此处的4代表幻灯片循环遍历的次数
                    ...
                    <div class="blk03">
                        <ul>
                            ...
                            <li><%=ad.AD_Show("Home_Scroll_Foot", "4", "cycle", 0)%></li>
                            <li><%=ad.AD_Show("Home_Scroll_Foot", "5", "cycle", 0)%></li>
                            <li><%=ad.AD_Show("Home_Scroll_Foot", "6", "cycle", 0)%></li>
                            <li><%=ad.AD_Show("Home_Scroll_Foot", "7", "cycle", 0)%></li>
                            <li><%=ad.AD_Show("Home_Scroll_Foot", "8", "cycle", 0)%></li>
            ...
            <div class="foot">
                ...
                <div class="foot_info01">
                    <div class="foot_info01_main">
                        ...
                        <%if (ad.AD_Show("Home_NewProduct_AboveImg", "1", "cycle", 0) != null)
                            {
                        %>
                        <dl>
                            <%=ad.AD_Show("Home_NewProduct_AboveImg", "1", "cycle", 0)%>
                        </dl>
                        <%} %>
                        <%if (ad.AD_Show("Home_NewProduct_AboveImg", "2", "cycle", 0) != null)
                            {
                        %>
                        <dl>
                            <%=ad.AD_Show("Home_NewProduct_AboveImg", "2", "cycle", 0)%>
                        </dl>
                        <%} %>
                        <%if (ad.AD_Show("Home_NewProduct_AboveImg", "3", "cycle", 0) != null)
                            {
                        %>

                        <dl>

                            <%=ad.AD_Show("Home_NewProduct_AboveImg", "3", "cycle", 0)%>
                        </dl>
                        <%} %>

                        <%if (ad.AD_Show("Home_NewProduct_AboveImg", "4", "cycle", 0) != null)
                            {
                        %>

                        <dl>
                            <%=ad.AD_Show("Home_NewProduct_AboveImg", "4", "cycle", 0)%>
                        </dl>
                        <%} %>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="f">
                ...
                <div class="f2_right" style="height: 564px;">
                    <ul>
                        ...
                        <li style="float: left; width: 60px;"><span>地址</span></li>
                    </ul>
