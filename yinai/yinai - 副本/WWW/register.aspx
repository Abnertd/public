                ...
                <form name="regform" id="regform" action="/member/register_do.aspx" method="post" onsubmit="return check_regform();">
                    <ul style="width: 810px;">
                        ...
                        <li style="font-size: 14px; color: #666; padding: 0 0 0 117px;">
                            <input name="checkbox_agreement1" id="checkbox_agreement1" type="checkbox" value="1" checked="checked" />已阅读并同意<a href="/help/index.aspx?help_id=40" target="_blank" class="a04">《易耐网会员协议》</a>
                            <br />
                            <input name="checkbox_agreement2" id="checkbox_agreement2" type="checkbox" value="1" checked="checked" />已阅读并同意<a href="/help/index.aspx?help_id=40" target="_blank" class="a04">《易耐网中信附属账户开通协议》</a>
                        </li>
