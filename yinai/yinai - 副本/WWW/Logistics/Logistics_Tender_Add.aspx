...
<%--                            <h3 style="padding: 10px;">商品清单</h3>
                        ...
                        <div class="b02_main">
                            <ul style="width:850px;">
                                <li><span><i>*</i>车型：</span><label><input name="Logistics_AuditRemarks" id="Logistics_AuditRemarks" type="text" style="width: 298px;" /></label></li>
                                <li><span><i>*</i>载重：</span><label><input name="Logistics_Number" id="Logistics_Number" type="text" style="width: 298px;" /></label></li>
                                <li><span><i>*</i>价格：</span><label><input name="Logistics_Tender_Price" id="Logistics_Tender_Price" type="text" style="width: 298px;" /></label></li>
