        ...
        <div class="content03">
            ...
            <form name="ordersform" id="ordersform" method="post" action="/cart/order_confirm_do.aspx">
                ...
                <ul style="align-content: center;">
                    <li style="align-content: center; font-size: 14px; color: #666; padding: 0 0 0 117px;  margin-left:25%">
                        <input name="checkbox_agreement" id="checkbox_agreement" type="checkbox" value="1" checked="checked" />已阅读并同意
                        <a href="/help/index.aspx?help_id=40" target="_blank" class="a04">《易耐网争议处理规则》</a>
                        <a href="/help/index.aspx?help_id=40" target="_blank" class="a04">《易耐网中信附属账户开通协议》</a>
                    </li>
                </ul>
