...
<% 
    ...
    if (entity != null)
    {
        ...
        orders.SetOrdersGoods_To_GoodsTmp(Orders_ID);
            ...
            <div class="partd_1">
                ...
                <div class="pd_right" style="width: 972px;">
                    <div class="blk14_1" style="margin-top: 0px;">
                        <div class="b06_info03_sz">

                            <h2>商品订单合同<span></span></h2>
                            <h3>
                                <ul>
                                    <li style="width: 394px;">商品</li>
                                    <li style="width: 190px;">单价</li>
                                    <li style="width: 190px;">数量</li>
                                    <li style="width: 190px; border-right: none;">小计（元）</li>
                                </ul>
                                <div class="clear"></div>
                            </h3>
                            <div class="b06_info03_main_sz">
                                <form name="frm_batch" action="/member/orders_do.aspx?Orders_ID=<%=Orders_ID%>" method="post">
                                    <% member.Edit_Orders_Details(orders_sn); %>
