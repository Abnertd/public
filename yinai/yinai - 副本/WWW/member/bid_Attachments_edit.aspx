...
<% 
    ...
    member.Member_Login_Check("/member/bid_Attachments_edit.aspx?AttID=" + AttID);
...
<head>
    ...
    <title><%="修改附件 - 我是买家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> > <a href="/member/bid_list.aspx">招标列表</a> ><span>修改附件</span></div>
            <div class="partd_1">
                <div class="pd_left">
