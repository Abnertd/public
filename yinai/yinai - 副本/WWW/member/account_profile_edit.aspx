...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> > <strong>资料修改</strong></div>
            <!--位置说明 结束-->
                        ...
                        <div class="blk07_sz">
                            ...
                            <div class="b07_main_sz">
                                <div class="b07_info04">
                                    <form name="frm_account_profile_edit" id="frm_account_profile_edit" method="post" action="/member/account_do.aspx">
