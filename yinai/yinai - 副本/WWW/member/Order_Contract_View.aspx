...
<% 
    ...
    if (ContractInfo != null)
    {
     ...
     srcString=   member.ReplaceOrdersContract_New(entity, ContractInfo.Contract_ID);
...
<head>
    <title><%="合同详情 - 我是买家 - " + pub.SEO_TITLE()%></title>
            ...
            <div class="partd_1">
                ...
                <div class="pd_right" style="width: 972px;">
                     <div class="blk14_1" style="margin-top: 0px;">                      
                          <h2 style="margin-bottom: 10px;">合同预览
                           <%if (entity.Orders_Status!=3)
                             {
                                 
                             %>   
                              <span> <a href="javascript:void();" name="btn_print" type="button" class="btn_01" id="Button4" value="合同下载" onclick="window.open('Contract_view.aspx?action=print&contract_id=<% =Contract_ID %>    ')" >合同下载</a></span>
