...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单配送方式</td>
    </tr>
    <tr>
      ...
      <form id="Form1" name="frm_delivery" method="post" action="orders_do.aspx?orders_id=<%=Orders_ID%>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
			  <tr>
				...
				<td align="left" class="cell_content"><%=myApp.Delivery_Way_Select(Orders_ID, Orders_Delivery, Orders_Address_State, Orders_Address_City, Orders_Address_County)%></td>
			  </tr>
			  <tr>
			    <td height="23" align="right" class="cell_title">费用</td>
			    <td align="left" class="cell_content"><input type="text" name="orders_total_freight" id="orders_total_freight" value="<%=Orders_Total_Freight%>" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"/></td>
			  </tr>
          ...
          <tr>
            ...
            <input name="button" type="submit" class="bt_orange" id="Submit2" value="保存" />
				<input name="action" type="hidden" id="action" value="order_delivery" />
