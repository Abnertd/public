...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SupplierInfo buyerinfo = supplier.GetSupplierByID(Orders_BuyerID);
        if (buyerinfo != null)
        {
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    ...
    <tr>
      ...
      <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
           <td><div style="margin:5px 0px;"><%=myApp.GetOrdersGoodsByOrdersID(Orders_ID)%></div></td>
        </tr>
        <%--<tr class="orders_tdbg">
            ...
            <form id="frm_ordersign" name="frm_ordersign" method="post" action="orders_do.aspx?orders_id=<%=Orders_ID%>">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    ...
                    <td><input name="Orders_Admin_Sign" type="radio" id="admin_sign_0" value="0"/>
                  ...
                  <tr>
                    ...
                    <td><textarea name="Orders_Admin_Note" id="Orders_Admin_Note" cols="45" rows="5"><%=Orders_Admin_Note%></textarea></td>
                  </tr>
                  <% if (Public.CheckPrivilege("c4de02f2-c819-4ae3-9a6e-be8645b5271f")) { %>
                  <tr>
                    <td>&nbsp;</td>
                    <td><input name="button" type="submit" class="bt_orange" id="button" value="保存" />
        ...
        <tr>
           <td><div style="padding:5px;"><%=ordersLog.GetOrdersLogsByOrdersID(Orders_ID)%></div></td>
        </tr>
