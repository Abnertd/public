...
<script runat="server">
    ...
    private string Ask_Content, Ask_Reply, member_name, product_name;
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
            ...
            <tr>
                <td class="content_content">
                    <form id="formadd" name="formadd" method="post" action="/Product/shopping_ask_Do.aspx?target=<%=target%>">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
                            ...
                            <tr>
                                ...
                                <td class="cell_content">
                                    <textarea name="Ask_Reply" id="Ask_Reply" cols="50" rows="5"><%=Ask_Reply%></textarea></td>
                            </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                                <td align="right">
                                    <input type="hidden" id="Ask_ID" name="Ask_ID" value="<%=Ask_ID %>" />
                                    <input type="hidden" id="action" name="action" value="renew" />
                                    <input name="save" type="submit" class="bt_orange" id="save" value="提交回复" />
