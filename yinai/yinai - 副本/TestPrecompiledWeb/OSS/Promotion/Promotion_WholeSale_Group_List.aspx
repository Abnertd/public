...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">批发促销分组 [<a href="promotion_WholeSale_group_add.aspx">添加批发促销分组</a>]</td>
    </tr>
    <tr>
      ...
      <tr><td>
      <form action="promotion_WholeSale_group_list.aspx" method="post" name="frm_sch" id="frm_sch" >
    ...
    <tr>
      <td>
        ...
        <script type="text/javascript">
        jQuery("#list").jqGrid({
        url: 'Promotion_WholeSale_group_do.aspx?action=list&<%=ReqURL %>',
			datatype: "json",
            colNames: ['ID', '分组名称', "操作"],
            colModel: [
				{width:50, name: 'PromotionWholeSaleGroupInfo.Promotion_WholeSale_Group_ID', index: 'PromotionWholeSaleGroupInfo.Promotion_WholeSale_Group_ID', align: 'center'},
            ...
            sortname: 'PromotionWholeSaleGroupInfo.Promotion_WholeSale_Group_ID',
			sortorder: "desc",
			rowNum: GetrowNum(),
			rowList: GetrowList(), 
			pager: 'pager', 
