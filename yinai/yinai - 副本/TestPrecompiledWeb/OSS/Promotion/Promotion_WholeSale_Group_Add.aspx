...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">添加批发促销分组</td>
    </tr>
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
        ...
        <tr>
	      ...
	      <td class="cell_content"> <input name="Promotion_Wholesale_Group_Name" value="" type="text" id="Promotion_Wholesale_Group_Name" size="40" maxlength="50"> &nbsp; </td>
	    </tr>   
