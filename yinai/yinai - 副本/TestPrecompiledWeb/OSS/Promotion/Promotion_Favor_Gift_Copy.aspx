    ...
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table">
        ...
        <tr>
			      <td class="cell_title">
                      优惠标题</td>
			      <td class="cell_content"><input name="Promotion_Gift_Title" type="text" id="Promotion_Gift_Title" size="40" value="<%=entity.Promotion_Gift_Title %>" maxlength="50" onblur="check_blank('Promotion_Gift_Title')"> <span id="tip_Promotion_Gift_Title"></span></td>
			    </tr>
			    
			    <tr id="pro_tr"  <%if(entity.Promotion_Gift_Target==0){Response.Write("style='display:none;'");} %>>
			      <td class="cell_title">
                      范围选择</td>
			    ...
			    <tr>
			      <td class="cell_title">
                      优惠排除</td>
			      <td class="cell_content"> <input type="checkbox" name="Promotion_Gift_Group" value="1" <%if (entity.Promotion_Gift_Group==1){Response.Write("Checked");} %>/> 团购产品  <input type="checkbox" name="Promotion_Gift_Limit" value="1" <%if (entity.Promotion_Gift_Limit==1){Response.Write("Checked");} %>/> 限时产品
                  </td>
			    </tr>
			    <tr>
			      <td class="cell_title">
                      叠加使用</td>
			      <td class="cell_content"> <input type="radio" name="Promotion_Gift_IsRepeat" value="1" <%if (entity.Promotion_Gift_IsRepeat==1){Response.Write("Checked");} %>/> 支持  <input type="radio" name="Promotion_Gift_IsRepeat" value="0" <%if (entity.Promotion_Gift_IsRepeat==0){Response.Write("Checked");} %> /> 不支持
                  </td>
			    </tr>
                  <%
                      int i;
             ...
             n = 1;           
                     ...
                     if (entity.Promotion_Gift_Amounts != null)
                     {
                         ...
                         {
                             n=n+1;
                             Response.Write("<div id=\"gift_" + n + "\">购买金额 ≥ <input type=\"text\" name=\"favor_buy_money" + n + "\" value=\"" + subamount.Gift_Amount_BuyAmount + "\" size=\"10\"/>  &nbsp;购买数量 ≥ <input type=\"text\" name=\"favor_buy_amount" + n + "\" value=\"" + subamount.Gift_Amount_Amount + "\" size=\"10\"/><input name=\"maxnum_" + n + "\" id=\"maxnum_" + n + "\" type=\"hidden\" value=\"" + subamount.Promotion_Gift_Gifts.Count + "\" />  ");
                             if(n==1)
                             {
                                 Response.Write("<a href=\"javascript:void(0);\" onclick=\"add_item();\"><span class=\"t12_blue\">添加可选项目</span></a>");
                             }
                             else
                             {
                                 Response.Write("<a href=\"javascript:void(0);\" onclick=\"del_item('gift_" + n + "');\"><span class=\"t12_blue\">删除</span></a>"); 
                             }
                             Response.Write("</div>");
                             if (subamount.Promotion_Gift_Gifts != null)
                                 {
                                    i=0;
                                     ...
                                     {
                                         i=i+1;
                                         Response.Write("<div id=\"gift_" + n + "_" + i + "\">");
                                         myApp.Promotion_Gift("promotion_gift"+i +"_" + n,subgift.Gift_ProductID); 
                                         Response.Write("&nbsp; 赠送数量 <input type=\"text\" name=\"favor_buy_gift"+i+"_amount_"+n+"\" value=\""+subgift.Gift_Amount+"\" size=\"10\"/> ");
                                         if (i == 1)
                                         {
                                             Response.Write("<a href=\"javascript:void(0);\" onclick=\"add_gift(" + n + ");\"><span class=\"t12_blue\">添加赠品</span></a>");
                                         }
                                         else
                                         {
                                             Response.Write("<a href=\"javascript:void(0);\" onclick=\"del_gift('gift_" + i + "_" + n + "')\"><span class=\"t12_blue\">删除</span></a>");
                                         }
                                         Response.Write("</div> ");
			                             Response.Write("<span id=\"gift_more"+n+"\"></span>");
			    ...
			    <tr>
			      ...
			      <td class="cell_content"><input type="text" class="input_calendar" name="Promotion_Gift_Starttime" id="StartDate" maxlength="10" readonly="readonly" value="<%=entity.Promotion_Gift_Starttime.ToShortDateString() %>" /> - <input type="text" class="input_calendar" name="Promotion_Gift_Endtime" id="EndDate" maxlength="10" readonly="readonly" value="<%=entity.Promotion_Gift_Endtime.ToShortDateString() %>" /><span id="tip_valid"></span>
                  <script type="text/javascript">
          ...
          <td class="cell_content"><input name="Favor_Sort" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" type="text" id="Favor_Sort" size="10" maxlength="10" value="<%=entity.Promotion_Gift_Sort %>" />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <input name="save" type="submit" class="bt_orange" id="save" value="保存" /><input name="group" id="group" type="hidden" value="<%=n %>" />
