                ...
                <td valign="top" height="31" class="opt_foot">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="opt_gap">&nbsp;</td>
                            <td class="opt_uncur" id="frm_opt_3"><%=Public.Page_ScriptOption("choose_opt(3,4);", "拍卖清单")%></td>
            ...
            <tr>
                <td class="content_content">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table" id="frm_optitem_1">
                        ...
                        <tr>
                            <td class="cell_title">拍卖用户</td>
                            <td class="cell_content"><% =Bid_MemberCompany%></td>
                        </tr>

                    <%--    <tr>
                            <td class="cell_title">报名时间</td>
                            <td class="cell_content"><% =Bid_EnterStartTime.ToString("yyyy-MM-dd")%>至<%=Bid_EnterEndTime.ToString("yyyy-MM-dd") %></td>
                        </tr>--%>

                         <tr>
                            <td class="cell_title">竞价时间</td>
                            <td class="cell_content"><% =Bid_BidStartTime.ToString("yyyy-MM-dd")%>至<%=Bid_BidStartTime.ToString("yyyy-MM-dd") %></td>
                        </tr>

                        <tr>
                            <td class="cell_title">竞价轮次</td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table" id="frm_optitem_3" style="display: none;">
                        ...
                        <%--    <td class="cell_title" style="text-align:center;">产品编号</td>--%>
                          ...
                          <%--  <td class="cell_title" style="text-align:center;">品牌</td>--%>
                            ...
                            <td class="cell_title" style="text-align:center;">缩略图</td>
                            <td class="cell_title" style="text-align:center;">备注</td>
                        </tr>
                        <%=myApp.BidPoductList(Products,1) %>
                    </table>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table" id="frm_optitem_4" style="display: none;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                            <tr>
                                <td align="left">
                                    <%if(Bid_IsAudit==0) {%>
                                    <input name="button" type="button" class="bt_orange" id="button1" value="审核通过" onclick="Audit('AuctionAudit');" />
                                    <input name="button" type="button" class="bt_orange" id="button2" value="审核不通过" onclick="Audit('AuctionNotAudit');" />
