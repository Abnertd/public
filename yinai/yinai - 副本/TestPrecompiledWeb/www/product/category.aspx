...
<%
    ...
    region_id = tools.CheckInt(Request["region_id"]);
    ...
    string navstr = product.Get_Cate_Nav(cate_id, "&nbsp;>&nbsp;");
    if (navstr.Length == 0)
    {
        navstr += "&nbsp;>&nbsp;商品分类";
    }
...
<head>
    ...
    <%--    <script src="../layer.m/layer.m.js" type="text/javascript"></script>--%>
...
<body>
    ...
    <div class="content">
        <!--位置 开始-->
        <div class="position">当前位置 > <a href="/index.aspx">首页</a>  > 商城选购</div>
        <!--位置 结束-->
        <!--筛选 开始-->
        ...
        <div class="partf">
            ...
            <div class="pf_left">
                <div class="blk07">
                    ...
                    <div class="b07_main">
                        <ul>
                            <%=product.Product_LeftSale_Product_new("商城选购-热销排行", 5,10)%>
                        </ul>
                    </div>
                </div>
                <div class="blk08">
                    ...
                    <div class="b08_main">
                        <ul>
                            <%=product .GuessLikeProduct_new("商城选购-推荐商品",5,11) %>
                        </ul>
            ...
            <div class="pf_right">
                ...
                <div class="blk11" style="padding-left: 0px;">
