...
<% 
    ...
    member.Member_Login_Check("/member/auction_tender_add.aspx?BID=" + BID);
    Bid MyBid = new Bid();
    ...
    if (!MyBid.IsSignUp(BID, tools.NullInt(Session["supplier_id"])))
    {
        Response.Redirect("/member/auction_list.aspx");
    }
...
<head>
    <title><%="竞价添加 - 我是买家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> > 拍卖管理 > <strong>添加竞价</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">

                    <% =member.Member_Left_HTML(2, 4) %>
                </div>
                <div class="pc_right">
                    ...
                    <div class="blk02">
                        ...
                        <div class="b14_1_main" id="aa01" style="border: 0px solid #dddddd; display: none;">
                            <table width="975" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 0px solid #eeeeee;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><%=entity.Bid_BidStartTime.ToString("yyyy-MM-dd") %>至<%=entity.Bid_BidEndTime.ToString("yyyy-MM-dd") %></td>
                                </tr>
                                <tr>

                                    <td class="name">保证金</td>
                                    <td><%=pub.FormatCurrency(entity.Bid_Bond) %></td>
                                   <td class="name">拍卖轮次</td>
                                    <td><%=entity.Bid_Number %></td>
                                </tr>
                            </table>
                            ...
                            <div class="blk11_1" style="margin-top: 20px;">
                                <h2 style="font-size: 15px; font-weight: bold;">竞价商品清单</h2>
                                <table width="975" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #eeeeee;">
                                    <tr>
                                        ...
                                        <td width="80" class="name">拍卖数量</td>
                                        <td width="80" class="name">起标价格</td>
                                    </tr>
                                    <%MyBid.AuctionProductList(entity.BidProducts, entity.Bid_Status, 1); %>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="b14_1_main" id="aa02" style="border: 0px solid #dddddd; display: none;">
                            ...
                            <form name="frm_bid" id="frm_bid" method="post" action="/member/auction_tender_do.aspx">
                                <%MyBid.Tender_List(BID, entity.BidProducts, entity.Bid_Number, entity.Bid_SupplierID, entity.Bid_BidEndTime, 1); %>
