...
<%--    <uctop:top ID="top1" runat="server" />--%>
    ...
    <div class="content02">
        <div class="content02_main">
            <!--位置说明 开始-->
            <div class="position"><a href="/tradeindex.aspx" >首页</a> > <a href="/member/">采购商用户中心</a> > 信贷管理 > <strong>信贷付款明细</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pc_left">
                    <div class="blk12">
                ...
                <div class="pc_right">
                    <div class="title03">信贷付款明细</div>

                    <%=member.Member_Loan_Project_CreditDetail_Search() %>

                    <div class="blk08">
                        <%member.Member_Loan_Project_CreditDetail(15); %>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
