...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Supplier_Shop_Intro.aspx");
    ...
    SupplierShopPagesInfo entity = supplier.GetSupplierShopPagesByIDSign("INTRO", tools.NullInt(Session["supplier_id"]));
    if (entity != null)
    {
...
<head>
    <title><%="店铺介绍 - 会员中心 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content">
        <!--位置说明 开始-->
        <div class="position">
            您现在的位置 > <a href="/">首页</a> > <a href="index.aspx">会员中心</a> > <a href="Supplier_Shop_Intro.aspx">店铺介绍</a>
        </div>
        <div class="clear"></div>
        <!--位置说明 结束-->
        <div class="parth">
                    ...
                    <div class="main">
                        ...
                        <form name="formadd" method="post" action="/supplier/Supplier_Shop_Pages_do.aspx">
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
                                <tr>
                                    <td align="right" height="24" width="50" class="t12_53">图片</td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="Shop_Pages_Sign" type="hidden" id="Shop_Pages_Sign" value="INTRO"><input name="action" type="hidden" id="action" value="new"><input name="btn_submit" type="image" src="/images/save.jpg" /></td>
                                </tr>
                            </table>
