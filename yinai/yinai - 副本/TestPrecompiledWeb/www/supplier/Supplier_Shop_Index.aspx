...
<% 
    ...
    SupplierShopPagesInfo entity = supplier.GetSupplierShopPagesByIDSign("INDEX", tools.NullInt(Session["supplier_id"]));
    if (entity != null)
    {
...
<head>
    <title><%="店铺首页右侧自定义 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 店铺管理 > <strong>店铺首页右侧自定义</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">
                    <%--   <div class="blk12">--%>
                ...
                <div class="pd_right">
                    <div class="blk14_1" style="margin-top:0px;">
                        <%--  <div class="title03">店铺首页右侧自定义</div>--%>
                        <h2>店铺首页右侧自定义</h2>
                        <div class="blk17_sz">
                            <form name="formadd" id="formadd" method="post" action="/supplier/Supplier_Shop_Pages_do.aspx">
                                <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
                                    ...
                                    <tr>
                                        ...
                                        <tr><td colspan="2"> <span style="color:#ff6660;position:relative; " >说明:店铺首页右侧自定义 显示在店铺商家介绍上方位置</span></td></tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="Shop_Pages_Sign" type="hidden" id="Shop_Pages_Sign" value="INDEX">
