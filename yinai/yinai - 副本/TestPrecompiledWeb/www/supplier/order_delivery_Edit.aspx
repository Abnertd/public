...
<% 
    ...
    int Supplier_ID = 0;
   SupplierInfo supplierinfo= new Supplier().GetSupplierByID();
   if (supplierinfo!=null)
   {
    ...
    if (entity == null)
    {
        pub.Msg("error", "错误信息", "记录不存在", false, "/supplier/order_delivery_view.aspx?Orders_Delivery_ID=" + Orders_Delivery_ID + "");
    }
    if (entity.Orders_SupplierID != Supplier_ID)
    {
        pub.Msg("error", "错误信息", "记录不存在", false, "/supplier/order_delivery_view.aspx?Orders_Delivery_ID=" + Orders_Delivery_ID + "");
    }
%>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/member/index.aspx">我是卖家</a> > <strong>发货单详情</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">                 
