...
<% 
    ...
    if (entity != null)
    {
         bidinfo = Mybid.GetBidByID(entity.Bid_BidID);
        if (bidinfo != null)
        {
            ...
            <div class="partd_1">
                ...
                <div class="pd_right">
                    ...
                    <div class="blk02">
                        <h2>
                            <ul>
                                <li class="on">拍卖商品详情<img src="/images/icon15.jpg"></li>
                            </ul>
                        </h2>
                        ...
                        <div class="b02_main">
                            <ul style="width:850px;">
                                ...
                                <div class="clear"></div>
                                <li><span><i>*</i>起标价格：</span><label><%=entity.Bid_Product_StartPrice %></label></li>
                                <div class="clear"></div>
...
<%--                                <li><span><i>*</i>重新图片：</span><label><iframe id="iframe2" src="<% =Application["Upload_Server_URL"]%>/public/uploadify.aspx?App=BidProduct&formname=frm_bid&frmelement=Bid_Product_Img&rtvalue=1&rturl=<% =Application["Upload_Server_Return_WWW"]%>" width="100%" height="90" frameborder="0" scrolling="no"></iframe></label></li>
                                ...
                                <li><a href="/supplier/auction_view.aspx?BID="<%=bidinfo.Bid_ID %>""  class="a05">返 回</a></li>
                            </ul>
