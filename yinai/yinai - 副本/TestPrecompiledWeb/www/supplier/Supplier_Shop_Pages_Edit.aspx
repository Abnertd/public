...
<% 
    ...
    string Shop_Pages_Title = "";
    int Shop_Pages_Sort = 0;
    int Shop_Pages_ID = 0;
    string Shop_Pages_Sign = tools.CheckStr(Request["sign"]);
    if (Shop_Pages_Sign.Length == 0)
    {
        pub.Msg("error", "错误信息", "记录不存在", false, "/supplier/Supplier_Shop_Pages_List.aspx");
    }
    SupplierShopPagesInfo entity = supplier.GetSupplierShopPagesByIDSign(Shop_Pages_Sign, tools.NullInt(Session["supplier_id"]));
    if (entity != null)
    {
...
<head>
    <title><%="店铺栏目管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 店铺管理 > <strong>店铺栏目管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">
                            ...
                            <form name="formadd" id="formadd" method="post" action="/supplier/Supplier_Shop_Pages_do.aspx">
                                <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Shop_Pages_Title" type="text" id="Shop_Pages_Title" class="txt_border" size="40" maxlength="100" value="<%=Shop_Pages_Title %>" /><i>*</i>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Shop_Pages_ID" type="hidden" id="Shop_Pages_ID" value="<%=Shop_Pages_ID %>" />
