...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/PurchaseReply_list.aspx");
...
<body>
    ...
    <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->         
        <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a> <strong>报价留言</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">              
                ...
                <div class="pd_right">
                  ...
                  <%--  <div class="title03"></div>--%>
                    ...
                    <div class="b14_1_main" >                        
                        <%supplier.Supplier_PurchaseReply_List();%>
                    </div>
