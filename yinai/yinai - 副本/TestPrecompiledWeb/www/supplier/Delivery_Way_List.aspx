...
<head>
    <title><%="配送方式管理 - 会员中心 - " + pub.SEO_TITLE()%></title>
      ...
      <div class="parth">
            ...
            <div class="ph_right">
                  <div class="blk13">
                        ...
                        <div style="margin-bottom:10px;"><input type="button" class="buttonupload" value="添加配送方式" onclick="location='Delivery_Way_Add.aspx';"/></div>
                        <%supplier.Delivery_Way_List();%>
