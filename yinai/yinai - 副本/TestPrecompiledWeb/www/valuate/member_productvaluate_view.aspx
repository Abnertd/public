...
<% 
   ...
   if (evaluate_id == 0)
   {
       pub.Msg("error", "错误信息", "评价页面不存在", false, "index.aspx");
   }
   member.Member_Login_Check("/valuate/member_productvaluate_view.aspx");   
%>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> > <strong>商品评价详情</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">                 
