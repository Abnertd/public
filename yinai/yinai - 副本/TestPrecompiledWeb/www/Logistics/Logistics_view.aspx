...
<% 
    ...
    logistics.Logistics_Login_Check("/Logistics/Logistics_view.aspx?ID=" + ID);
    ...
    {
        if(logisticstenderinfo.Logistics_Tender_LogisticsID!=logisticsinfo.Logistics_ID)
        {
            Response.Redirect("/Logistics/Logistics.aspx");
        }
    }
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position"><a href="/">首页</a> > <a href="/Logistics/Logistics.aspx">物流商</a> > 物流列表 > <strong>物流详情</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">
