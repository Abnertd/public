...
<% 
    ...
    logistics.Logistics_Login_Check("/Logistics/Logistics_password.aspx");
...
<head>
    <title><%="修改密码 - 物流商用户中心 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position"><a href="/">首页</a> > <a href="/Logistics/Logistics.aspx">物流商</a> > <strong> 修改密码 </strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">

                    <% logistics.Get_Logistics_Left_HTML(2, 1); %>
                </div>
                <div class="pc_right">
                                    ...
                                    <form name="frm_account_profile" id="frm_account_profile" method="post" action="/Logistics/Logistics_do.aspx">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                ...
                                                <td width="755">
                                                    <input name="Member_oldpassword" type="password" style="width: 300px;" class="input01" id="Member_oldpassword" /><span>* 输入原密码</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="Member_password" type="password" style="width: 300px;" class="input01" id="Member_password" /><span>* 请输入6～20位密码（A-Z，a-z，0-9，不要输入空格）</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="Member_password_confirm" style="width: 300px;" class="input01" type="password" id="Member_password_confirm" /><span>*   请再次输入密码</span>
                                                </td>
                                            </tr>
