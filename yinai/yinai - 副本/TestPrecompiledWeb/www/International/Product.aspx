...
<%    Public_Class pub = new Public_Class();
      ...
      cate_id = pub.CheckXSS(tools.CheckStr(Request["cate_id"]));
      second_cate = pub.CheckXSS(tools.CheckStr(Request["second_cate"]));   
                ...
                <div style="float: left;">
                    ...
                    <div class="pd_left">
                        <div class="pd_left">
                            <div class="menu_1">
                                <h2>Classfication</h2>
                                <%=cms.GetEnlishDetailsLeft(65,cate_id,second_cate)%>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="xqy_list">
                        <div class="xqy_list_main">
                            ...
                            <%cms.GetEnlishDetailsRight(65, cate_id, second_cate);%>
                        </div>
                    </div>
                </div>
            </div>
