...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (keyword != "输入姓名、电话、Email进行搜索" && keyword != null)
        {
            keyword = keyword;
        }
        else
        {
            keyword = "输入姓名、电话、Email进行搜索";
        }
        if (keyword == "输入姓名、电话、Email进行搜索")
        {
            defaultkey = "";
        }
        else
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
                ...
                <td>
                    ...
                    <input type="text" class="input_calendar" name="date_end" id="date_end" maxlength="10"
                        readonly="readonly" value="<%=date_end%>" />
                                    ...
                                    <input type="text" name="keyword" size="50" id="keyword" onfocus="if(this.value=='输入姓名、电话、Email进行搜索'){this.value='';}"
                                        value="<% =keyword %>">
            ...
            <tr>
                <td class="content_content">
                    ...
                    <script type="text/javascript">
                        jQuery("#list").jqGrid({
                            url: 'member_do.aspx?action=feedback&listtype=<% =listtype%>&date_start=<% =Request["date_start"]%>&date_end=<% =Request["date_end"]%>&<%=ReqURL %>',
            datatype: "json",
            ...
            colModel: [
				...
				{ width: 80, name: 'FeedBackInfo.Feedback_Addtime', index: 'MemberInfo.Feedback_Addtime', align: 'center' },
                        ...
                        <div style="margin-top: 5px;">
                            <div style="margin-top: 5px;">
                                ...
                                <% if (Public.CheckPrivilege("4190769c-4fd5-4013-a701-fe7594c1017f"))
                                   { %>
                                <input type="button" id="export" class="bt_orange" value="导出勾选<% =title%>" onclick="location.href = 'member_do.aspx?action=feedbackexport&feedback_id=' + jQuery('#list').jqGrid('getGridParam', 'selarrrow');" />
                                <%} %>
                            </div>
                    </form>
                </td>
