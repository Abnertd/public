  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    ...
    <tr>
      <td class="content_content">
        <form id="frmsearch" method="post" action="purchasing_nostock_list.aspx?Purchasing_Type=<%=Purchasing_Type%>">
        <table>
            <tr>
        ...
        jQuery("#list").jqGrid({
        url: 'purchasing_do.aspx?action=nolist&Purchasing_Type=<%=Purchasing_Type%>&Product_Code=<% =Server.UrlEncode(Request["Product_Code"])%>',
			datatype: "json",
        ...
        <input type="button" id="Button1" class="bt_orange" value="导出全部单据" onclick="location.href='purchasing_do.aspx?action=export&nostock=1&purchasing_type=<%=Purchasing_Type%>&product_code=<% =Server.UrlEncode(Request["Product_Code"])%>'" /> 
