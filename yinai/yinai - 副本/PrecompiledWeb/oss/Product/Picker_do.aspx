...
<%
        ...
        switch (action)
        {
            ...
            case "refresh_product":
                keyword = Request["keyword"];
                product_cate = 0;
                if (tools.CheckInt(Request["product_cate"]) == 0)
                {
                ...
                Response.Write("<script type=\"text/javascript\">");
                Response.Write("jQuery(\"#list\").jqGrid({");
                Response.Write("url: 'picker_do.aspx?action=productlist&product_cate=" + product_cate + "&keyword=" + Server.UrlEncode(keyword) + "',");
                Response.Write("    datatype: \"json\",");
