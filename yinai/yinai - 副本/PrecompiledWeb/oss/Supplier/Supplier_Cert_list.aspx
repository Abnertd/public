                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <tr>
                                    <td>
                                        <form action="Supplier_cert_list.aspx?Audit=<%=Audit %>" method="post" name="frm_sch" id="frm_sch">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td align="left"><span class="left_nav">搜索</span>

                                                        <input type="text" name="keyword" size="50" onfocus="if(this.value=='输入Email、公司名称进行搜索'){this.value='';}" id="keyword" value="<% =keyword %>">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <script type="text/javascript">
                                            jQuery("#list").jqGrid({
                                                url: 'Supplier_do.aspx?action=certlist&keyword=<%=Server.UrlEncode(defaultkey) %>&Audit=<%=Audit %>',
            datatype: "json",
            colNames: ['ID', '账号', '公司名称', '联系人', '所在地区', '供应商类型', '资质状态', "操作"],
            colModel: [
				{ width: 50, name: 'SupplierInfo.Supplier_ID', index: 'SupplierInfo.Supplier_ID', align: 'center' },
                { width: 100, name: 'SupplierInfo.Supplier_Account', index: 'SupplierInfo.Supplier_Account', align: 'center' },
				{ name: 'SupplierInfo.Supplier_Name', index: 'SupplierInfo.Supplier_Name', align: 'center' },
				{ width: 50, name: 'SupplierInfo.Supplier_Contactman', index: 'SupplierInfo.Supplier_Contactman', align: 'center' },
				{ width: 150, name: 'SupplierInfo.Supplier_Area', index: 'SupplierInfo.Supplier_Area', align: 'center' },
			    { width: 100, name: 'SupplierInfo.Supplier_CertType', index: 'SupplierInfo.Supplier_CertType', align: 'center', hidden: true },
                 { width: 50, name: 'SupplierInfo.Supplier_Cert_Status', index: 'SupplierInfo.Supplier_Cert_Status', align: 'center' },
