...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Orders_PaymentStatus != 0 || Orders_Status > 1)
        {
            Public.Msg("error", "错误信息", "所选订单正在支付中", false, "{back}");
        }
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单[<%=Orders_SN%>]支付信息</td>
    </tr>
    <tr>
      ...
      <form id="Form1" name="frm_delivery" method="post" action="orders_do.aspx?orders_id=<%=Orders_ID%>">
			...
			<tr>
				<td width="100" height="23" align="right" class="cell_title">支付金额</td>
			  ...
			  <tr>
				<td width="100" height="23" class="cell_title" align="right">支付备注</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <input name="button" type="submit" class="bt_orange" id="Submit1" value="保存" />
				...
				<input name="action" type="hidden" id="action" value="create_payment" />
