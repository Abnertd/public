...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((Orders_PaymentStatus != 1 && Orders_PaymentStatus != 4) || Orders_Status != 1)
        {
            Public.Msg("error", "错误信息", "所选订单未付款", false, "{back}");
        }
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单[<%=Orders_SN%>]退款信息</td>
    </tr>
    <tr>
      ...
      <form id="Form1" name="frm_delivery" method="post" action="orders_do.aspx?orders_id=<%=Orders_ID%>">
			...
			<tr>
				<td width="100" height="23" align="right" class="cell_title">退款金额</td>
				<td align="left" class="cell_content"><%=Public.DisplayCurrency(Orders_Total_AllPrice)%></td>
			  </tr>
			  <tr>
				<td width="100" height="23" align="right" class="cell_title">退款方式</td>
				<td align="left" class="cell_content"><input type="text" name="Orders_Payment_Name" id="Orders_Payment_Name" />&nbsp;&nbsp;<%myApp.Sys_Payway_Select(); %></td>
			  </tr>
			  <tr>
				<td width="100" height="23" class="cell_title" align="right">退款备注</td>
				<td align="left" class="cell_content"><textarea name="Orders_Payment_Note" id="Orders_Payment_Note" cols="50" rows="5"></textarea></td>
			  </tr>
			  <tr>
				<td></td>
				<td align="left">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <input name="button" type="submit" class="bt_orange" id="Submit1" value="保存" />
				<input type="hidden" name="Orders_Payment_Amount" value="<%=Orders_Total_AllPrice%>" /> 
				<input name="action" type="hidden" id="action" value="cancel_payment" />
