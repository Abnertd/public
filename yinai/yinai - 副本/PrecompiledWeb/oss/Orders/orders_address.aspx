...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Orders_DeliveryStatus != 0 || Orders_Status != 0||Orders_PaymentStatus!=0)
        {
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单收货人地址</td>
    </tr>
    <tr>
      ...
      <form id="Form1" name="frm_delivery" method="post" action="orders_do.aspx?orders_id=<%=Orders_ID%>">
			...
			<tr>
				<td width="100" height="23" align="right" class="cell_title">省份</td>
				<td align="left" class="cell_content">
				<input type="hidden" name="Orders_Address_Country" id="Orders_Address_Country" value="CN" />
				<input type="hidden" id="Orders_Address_State" name="Orders_Address_State" value="<%=Orders_Address_State %>">
                <input type="hidden" id="Orders_Address_City" name="Orders_Address_City" value="<%=Orders_Address_City %>">
                <input type="hidden" id="Orders_Address_County" name="Orders_Address_County" value="<%=Orders_Address_County %>">
				<span id="textDiv"><%=Addr.SelectAddress("textDiv", "Orders_Address_State", "Orders_Address_City", "Orders_Address_County", Orders_Address_State, Orders_Address_City, Orders_Address_County)%></span></td>
			  </tr>
			  <tr>
				<td width="100" height="23" align="right" class="cell_title">收货地址</td>
				<td align="left" class="cell_content"><input name="Orders_Address_StreetAddress" type="text" id="Orders_Address_StreetAddress" size="60" maxlength="100" value="<%=Orders_Address_StreetAddress%>"/></td>
			  </tr>
			  <tr>
				<td width="100" height="23" align="right" class="cell_title">邮编</td>
				<td align="left" class="cell_content"><input name="Orders_Address_Zip" type="text" id="Orders_Address_Zip" size="20" maxlength="10" value="<%=Orders_Address_Zip%>"/></td>
			  </tr>
			  <tr>
				<td width="100" height="23" align="right" class="cell_title">收货人姓名</td>
				<td align="left" class="cell_content"><input name="Orders_Address_Name" type="text" id="Orders_Address_Name" size="20" maxlength="50" value="<%=Orders_Address_Name%>"/></td>
			  </tr>
			  <tr>
				<td width="100" height="23" class="cell_title" align="right">联系电话</td>
				
				<td align="left" class="cell_content">
				<input name="Orders_Address_Phone_Countrycode" type="hidden" id="Orders_Address_Phone_Countrycode" value="+86" />
				<input name="Orders_Address_Phone_Number" type="text" id="Orders_Address_Phone_Number" size="20" maxlength="20" value="<%=Orders_Address_Phone_Number%>"/></td>
			  </tr>
			    <tr>
				<td width="100" height="23" class="cell_title" align="right">手机</td>
				<td align="left" class="cell_content"><input name="Orders_Address_Mobile" type="text" id="Orders_Address_Mobile" size="20" maxlength="20" value="<%=Orders_Address_Mobile%>"/></td>
			  </tr>
			  <tr>
				<td></td>
				<td align="left">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <input name="button" type="submit" class="bt_orange" id="Submit1" value="保存" />
				<input name="action" type="hidden" id="action" value="address_edit" />
