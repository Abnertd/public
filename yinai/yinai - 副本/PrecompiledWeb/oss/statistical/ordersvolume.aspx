...
<script runat="server">
    ...
    {
        Public.CheckLogin("dd2be22d-f543-430a-a465-4e5e9c176813");
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单量统计</td>
    </tr>
    <tr>
      <td class="content_content">
        ...
        <script type="text/javascript"> $("#salechart")[0].src = "/public/chart.aspx?type=ordersamountimg&width="+($(document).width() - 50) +"&height=300&<%=QueryURL%>";</script>
      </td>
    </tr>
  </table>
</div>
