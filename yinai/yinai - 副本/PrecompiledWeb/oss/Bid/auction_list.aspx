...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (keyword != "输入公告标题、拍卖用户、中标单位搜索" && keyword != null)
        {
            keyword = keyword;
        }
        else
        {
            keyword = "输入公告标题、拍卖用户、中标单位搜索";
        }
        if (keyword == "输入公告标题、拍卖用户、中标单位搜索")
        {
            defaultkey = "";
        }
        else
...
<body>
    <div class="content_div">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
            <tr>
                <td class="content_title">管理招标</td>
            </tr>
            <tr>
                <td height="5"></td>
            </tr>
            <tr>
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        <form action="auction_list.aspx" method="post" name="frm_sch" id="frm_sch">
                            <tr bgcolor="#F5F9FC">
                                ...
                                <td align="right">
                                    ...
                                    <input type="text" name="keyword" size="50" id="keyword" onfocus="if(this.value=='输入公告标题、拍卖用户、中标单位搜索'){this.value='';}" value="<% =keyword %>">
            ...
            <tr>
                <td class="content_content">
                    <table id="auctionlist"></table>
                    <div id="pager"></div>
                    <script type="text/javascript">
                        jQuery("#auctionlist").jqGrid({
                            url: 'bid_do.aspx?action=auctionlist&<%=ReqURL %>',
                datatype: "json",
                //colNames: ['ID', '公告标题', "拍卖用户", "报名时间", "竞价时间", "中标单位", "审核状态", "报名数", "竞价数", "操作"],
                colNames: ['ID', '公告标题', "拍卖用户", "竞价时间", "中标单位", "审核状态", "报名数", "竞价数", "操作"],
                colModel: [
