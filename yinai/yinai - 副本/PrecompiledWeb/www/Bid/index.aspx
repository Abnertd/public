...
<body>
    ...
    <div class="content">
        <!--位置 开始-->
        <div class="position">当前位置 > <a href="/">首页</a> > 招标拍卖</div>
        <!--位置 结束-->
        <div class="banner02">
        ...
        <div class="parte" style="border: none;">
            <div class="ccwl_part1 mat10">
                <ul>
                    <li><a href="javascript:void(0);" class="part1_on">招标</a></li>
                    <li><a href="/bid/auction.aspx">拍卖</a></li>
                </ul>
            </div>
            <div class="ccwl_part2">
                <form name="frm_bid" id="frm_bid" method="post" action="/Bid/index.aspx">
