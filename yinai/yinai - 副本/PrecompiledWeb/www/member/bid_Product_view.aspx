...
<% 
    ...
    if(entity!=null)
    {
        ...
        if (bidinfo != null)
        {
            if (bidinfo.Bid_MemberID != tools.NullInt(Session["member_id"]) || bidinfo.Bid_MemberID == 0 || bidinfo.Bid_Type == 1)
            {
...
<head>
    ...
    <title><%="商品清单 - 我是买家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> > <a href="/member/bid_list.aspx">招标列表</a> ><span>商品清单</span></div>
            <div class="partd_1">
                <div class="pd_left">
                    ...
                    <div class="blk02">
                        ...
                        <div class="b02_main">
                            <ul style="width:850px;">
                                <%--<li><span><i></i>物料编号：</span><label><%=entity.Bid_Product_Code %></label></li>
                                <div class="clear"></div>--%>
                               ...
                               <%-- <li><span><i></i>品牌：</span><label><%=entity.Bid_Product_Brand %></label></li>
                                ...
                                <div class="clear"></div>
                                <li><span><i></i>采购数量：</span><label><%=entity.Bid_Product_Amount %></label></li>
                                <div class="clear"></div>
