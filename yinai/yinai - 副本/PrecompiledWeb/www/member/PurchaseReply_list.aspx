...
<% 
    ...
    member.Member_Login_Check("/member/Purchasereply_list.aspx");
...
<body>
    ...
    <div class="webwrap">
        <div class="content02">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/member/index.aspx">我是买家</a> <strong>采购报价管理</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">                
                ...
                <div class="pd_right">
                    <div class="blk14_1" style="margin-top: 0px;">
                        ...
                        <div class="b14_1_main">
                            <%member.MemberPurchaseReplyList(); %>
                        </div>
                    </div>
                </div>
