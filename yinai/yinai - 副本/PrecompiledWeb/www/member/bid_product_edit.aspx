...
<% 
    ...
    member.Member_Login_Check("/member/Bid_Product_edit.aspx?ProductID=" + ProductID);
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 >  <a href="/member/index.aspx">我是买家</a> > <a href="/member/bid_list.aspx">招标列表</a> ><span>修改商品清单</span></div>
            <div class="partd_1">
                <div class="pd_left">
...
<%--                                <li><span><i>*</i>序号：</span><label><input name="Bid_Product_Sort" id="Bid_Product_Sort" type="text" style="width: 298px;" value="<%=entity.Bid_Product_Sort %>" /></label></li>
                                <div class="clear"></div>--%>
                                <%--<li><span><i>*</i>物料编号：</span><label><input name="Bid_Product_Code" id="Bid_Product_Code" type="text" style="width: 298px;" value="<%=entity.Bid_Product_Code %>" /></label></li>
                                <div class="clear"></div>--%>
                                ...
                                <div class="clear"></div>
                               <%-- <li><span><i>*</i>品牌：</span><label><input name="Bid_Product_Brand" id="Bid_Product_Brand" type="text" style="width: 298px;" value="<%=entity.Bid_Product_Brand %>" /></label></li>
                                <div class="clear"></div>--%>
                                ...
                                <div class="clear"></div>
                                <li><span><i>*</i>采购数量：</span><label><input name="Bid_Product_Amount" id="Bid_Product_Amount" type="text" style="width: 298px;" value="<%=entity.Bid_Product_Amount %>" /></label></li>
                                <div class="clear"></div>
                            ...
                            <input name="action" type="hidden" id="action" value="editProduct" />
