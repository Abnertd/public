...
<% 
    ...
    member.Member_Login_Check("/member/auction_tender_sign.aspx");
    Bid MyBid = new Bid();
...
<head>
    <title><%="拍卖报名列表 - 我是买家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/member/">我是买家</a> > 投标管理 > <span>报名列表</span></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">
                   <%-- <div class="menu_1">--%>
                ...
                <div class="pc_right">
                    ...
                    <div class="blk14_1" style="margin-top: 1px;">
                        ...
                        <div class="main" id="aa01">
                            <%MyBid.SupplierBidEnterList(1); %>
                        </div>
