        ...
        <div class="partd_1">
            ...
            <div class="pd_right">
                <div class="blk14_1" style="margin-top: 0px;">
                    <h2>中信支付管理</h2>
                    <%if (zhongxininfo != null && zhongxininfo.ReceiptAccount != "")//信息不为null的时候显示已添加信息，否则显示添加信息
                      { %>
                    <%--  <%if (zhongxininfo.ReceiptAccount != "")//信息不为null的时候显示已维护信息，否则显示添加信息
                      { %>--%>
                    <div class="b14_1_main">
                        ...
                        <div class="blk17_sz" style="margin-top: 0px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" class="table_padding_5">
                                <tr>
                                    <td width="100" align="right" class="t12_53">附属账户名
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    <td width="100" align="right" class="t12_53">附属账户开户行
                                    </td>
                                ...
                                <tr>
                                    <td align="right" class="t12_53">出金开户名
                                    </td>
                                    <td align="left">
                    ...
                    <div class="b14_1_main">
                        <form name="frm_account_profile" method="post" action="/supplier/account_do.aspx">
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" class="table_padding_5">
                                <tr>
                                    <td width="100" align="right" class="t12_53">单位名称
                                    </td>
                                ...
                                <tr>
                                    <td width="100" align="right" class="t12_53">出金开户银行
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    <td align="right" style="line-height: 24px;" class="t12_53">出金银行名称
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    <td align="right" class="t12_53">出金银行行号
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    <td align="right" class="t12_53">银行开户名称
                                    </td>
                                    <td style="text-align: left">
                                        <%=supplierinfo.Supplier_CompanyName%>
                                ...
                                <tr>
                                    <td width="100" align="right" class="t12_53">出金银行账号
                                    </td>
                                    <td style="text-align: left">
