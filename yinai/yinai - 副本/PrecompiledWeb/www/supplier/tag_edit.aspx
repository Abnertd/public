...
<% 
    ...
    string Product_Tag_Name = "", Product_Tag_Site = "";
    int Product_Tag_ID, Product_Tag_IsActive = 0, Product_Tag_IsSupplier = 0;
    int Product_Tag_Sort = 0;
    Product_Tag_ID = tools.CheckInt(Request.QueryString["product_tag_id"]);
    ProductTagInfo entity = new ProductTag().GetProductTagByID(Product_Tag_ID);
    ...
    else
    {
        ...
        Product_Tag_Sort = entity.Product_Tag_Sort;
...
<head>
    <title><%="商品标签管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            ...
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a><strong>商品标签管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">
                            ...
                            <form method="post" id="formadd" name="formadd" action="tag_do.aspx">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Product_Tag_Name" type="text" id="Product_Tag_Name" style="width: 300px;" class="input01" maxlength="50" value="<%=Product_Tag_Name %>" /></td>
                                    </tr>
                                    <tr>
                                        <td width="92" class="name">启用该标签</td>
                                        <td width="801">
                                            <input name="Product_Tag_IsActive" type="radio" id="radio" value="1" <%=pub.CheckRadio(Product_Tag_IsActive.ToString(),"1") %> style="display: inline-block; vertical-align: middle; padding: 0; border: none; -webkit-box-shadow: none; -moz-box-shadow: none;" />是
                                            <input type="radio" name="Product_Tag_IsActive" id="radio2" value="0" <%=pub.CheckRadio(Product_Tag_IsActive.ToString(),"0") %> style="display: inline-block; vertical-align: middle; padding: 0; border: none; -webkit-box-shadow: none; -moz-box-shadow: none;" />否 </td>
                                    </tr>
                                    <tr>
                                        <td width="92" class="name">排序</td>
                                        <td width="801">
                                            <input name="Product_Tag_Sort" type="text" value="<%= Product_Tag_Sort%>" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" class="input01" /></td>
                                    </tr>
                                    <tr>
