...
<% 
    ...
    int Supplier_Product_Cate_Parentid = 0;
    string Supplier_Product_Cate_Name = "";
    int Supplier_Product_Cate_Sort = 0;
    int Cate_ID = tools.CheckInt(Request["Cate_ID"]);
    if (Cate_ID == 0)
    {
        pub.Msg("error", "错误信息", "记录不存在", false, "/supplier/Product_Category_List.aspx");
    }
    SupplierCategoryInfo entity = supplier.GetSupplierCategoryByIDSupplier(Cate_ID, tools.NullInt(Session["supplier_id"]));
    if (entity != null)
    {
        Supplier_Product_Cate_Parentid = entity.Supplier_Cate_Parentid;
        Supplier_Product_Cate_Name = entity.Supplier_Cate_Name;
        Supplier_Product_Cate_Sort = entity.Supplier_Cate_Sort;
    }
    else
    {
        pub.Msg("error", "错误信息", "记录不存在", false, "/supplier/Product_Category_List.aspx");
...
<head>
    <title><%="店内分类管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content02" style="margin-bottom:20px;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 商品管理 > <strong>店内分类管理</strong></div>
            <!--位置说明 结束-->
            <div class="partd_1">
                <div class="pd_left">
                    <div class="menu_1">
                                    ...
                                    <tr>
                                        ...
                                        <td width="801">
                                            <select name="Cate_ParentID" style="width: 160px;">
                                                ...
                                                <%=supplier.Select_Supplier_Cate(0, Cate_ID, Supplier_Product_Cate_Parentid, 0)%>
                                            </select><i>*</i>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Cate_Name" type="text" id="Cate_Name"  style="width: 300px;" class="input01" value="<%=Supplier_Product_Cate_Name %>" /><i>*</i>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="801">
                                            <input name="Cate_Sort" type="text" id="Cate_Sort"  style="width: 300px;" class="input01" value="<%=Supplier_Product_Cate_Sort %>" /><i>*</i>
                                        </td>
                                    </tr>
                                    <tr>
