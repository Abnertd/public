...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Logistics_lsit.aspx");
...
<head>
    <title><%="物流列表 - 我是卖家 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="background-color: #FFF;">
            ...
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/supplier/">我是卖家</a> > 物流管理 > <strong>物流列表</strong></div>
            <!--位置说明 结束-->
            <div class="partc">
                <div class="pd_left">

                    <% supplier.Get_Supplier_Left_HTML(8, 1); %>
                </div>
                <div class="pc_right">
                    ...
                    <div class="blk14_1" style="margin-top: 1px;">
                        <h2>物流列表</h2>
                        <% MyLogistics.SupplierLogistics_List();%>
                    </div>
