...
<head>
    <title>
        <%="商品标签管理 - 我是卖家 - " + pub.SEO_TITLE()%></title>
        ...
        <div class="content02" style="background-color: #FFF;">
            ...
            <div class="partd_1">
                ...
                <div class="pd_right">
                    ...
                    <h2><span><a href="/supplier/tag_add.aspx" class="a13" style="float:right;margin-right:15px;color:#ffffff;font-weight:normal;font-size:12px;">添加标签</a></span>商品标签管理</h2>
                    <div class="b14_1_main" style="margin-top: 15px;">
                        <% new ProductTag().GetProductTags();%>
                    </div>
