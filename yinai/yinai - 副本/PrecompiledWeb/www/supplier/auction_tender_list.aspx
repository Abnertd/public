...
<% 
    ...
    supplier.Supplier_Login_Check("/member/auction_tender_list.aspx?BID=" + BID);
...
<head>
    ...
    <title><%="竞价列表 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">        
            <div class="position">当前位置 > <a href="/supplier/">我是卖家 > </a> <strong>竞价列表</strong></div>
             ...
             <div class="partd_1">
                ...
                <div class="pd_right">
                        ...
                        <div class="blk14_1" style="margin-top: 1px;">
                              <h2>竞价列表</h2>
                            <%Mybid.Tender_Member_List(BID,1); %>
                        </div>
