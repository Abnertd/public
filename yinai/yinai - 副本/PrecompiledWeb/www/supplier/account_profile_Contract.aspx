...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/supplier/index.aspx">我是卖家</a> > <strong>联系我们</strong></div>
            <!--位置说明 结束-->

            <div class="partd_1">
                <div class="pd_left">
                     <% supplier.Get_Supplier_Left_HTML(2, 15); %>
                </div>
                                ...
                                <div class="b07_info04" style="padding:0">
                                    ...
                                    <table width="972px;" border="0" cellspacing="0" cellpadding="5" class="table_padding_5">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <textarea cols="80" id="Member_Company_Contact" name="Member_Company_Contact" rows="16"> <%=memberInfo.Member_Company_Contact%></textarea>
                                                    <script type="text/javascript">
                                                        var About_ContentEditor;
                                                        KindEditor.ready(function (K) {
                                                            About_ContentEditor = K.create('#Member_Company_Contact', {
                                                                width: '972px;',
                                                                height: '358px',
                                                                filterMode: true,
                                        ...
                                        <tr>
                                            <td style="color:#ff6600;padding-left:10px;">说明:在商家店铺-联系我们页面展示</td>
                                        </tr>
                                            <tr>
                                              
                                                <td>
                                                    <input name="action" type="hidden" id="action" value="account_profile_SupplierContract"/>
