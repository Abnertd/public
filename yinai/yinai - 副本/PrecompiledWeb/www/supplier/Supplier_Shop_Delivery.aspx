...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/Supplier_Shop_Delivery.aspx");
    ...
    SupplierShopPagesInfo entity = supplier.GetSupplierShopPagesByIDSign("PAYDELIVERY", tools.NullInt(Session["supplier_id"]));
    if (entity != null)
    {
...
<head>
    <title><%="支付配送说明 - 会员中心 - " + pub.SEO_TITLE()%></title>
...
<div class="content">
      <!--位置说明 开始-->
      <div class="position">
		   您现在的位置 > <a href="/">首页</a> > <a href="index.aspx">会员中心</a> > <a href="Supplier_Shop_Service.aspx">支付配送说明</a>
	</div>
      <div class="clear"></div>
      <!--位置说明 结束-->
      <div class="parth">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content" class="table_padding_5">
        ...
        <tr>
              ...
              <td><input name="Shop_Pages_Sign" type="hidden" id="Shop_Pages_Sign" value="PAYDELIVERY"><input name="action" type="hidden" id="action" value="new"><input name="btn_submit" type="image" src="/images/save.jpg" /></td>
            </tr>
          </table>
            </form>
