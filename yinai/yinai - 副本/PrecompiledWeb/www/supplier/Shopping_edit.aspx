...
<% 
    ...
    Addr addr = new Addr();
    myApp.Supplier_Login_Check("/supplier/Shopping_edit.aspx");

    int apply_id = tools.CheckInt(Request["apply_id"]);
    int Purchase_CateID =0;
    if (apply_id == 0)
    {
    ...
    else
    {
        ...
        if (spinfo.Purchase_Status == 2 || spinfo.Purchase_Trash==1)
        {
            Response.Redirect("/supplier/Shopping_list.aspx");
        }
        //if (spinfo.Purchase_IsActive == 1)
        //{
        //    Response.Redirect("/supplier/Shopping_list.aspx");
        //}
        Purchase_CateID= spinfo.Purchase_CateID;
    }
%>
...
<head>
    <title>
        <%="修改采购申请 - 会员中心 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="content">
        <!--位置说明 开始-->
        <div class="position">
            您现在的位置 > <a href="/">首页</a> > <a href="index.aspx">会员中心</a> > <span>修改采购申请</span>
        </div>
        <div class="clear">
        </div>
        <!--位置说明 结束-->
        <div class="parth">
            ...
            <div class="ph_right">
                        ...
                        <div class="zkw_order">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5" id="apply_1_content"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input type="radio" value="0" name="Purchase_TypeID" <%=pub.CheckedRadio(spinfo.Purchase_TypeID.ToString(),"0") %> />定制采购
                                        <input type="radio" value="1" name="Purchase_TypeID" <%=pub.CheckedRadio(spinfo.Purchase_TypeID.ToString(),"1") %> />代理采购
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input name="Purchase_Title" type="text" id="Purchase_Title" class="txt_border" maxlength="100"
                                            value="<%=spinfo.Purchase_Title %>" />
                                        <span class="t12_red">*</span>
                                    </td>
                                </tr>
                                         <tr>
                ...
                <td align="left">
                    <span id="main_cate"><%=myApp.Purchase_Category_Select(Purchase_CateID, "main_cate")%></span>
            <span id="div_Purchase_Cate"></span>
                    <span class="t12_red">*</span>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input type="text" class="input_calendar" name="Purchase_DeliveryTime" id="Purchase_DeliveryTime"
                                            maxlength="10" readonly="readonly" value="<%=spinfo.Purchase_DeliveryTime.ToString("yyyy-MM-dd") %>" />
                                        <span class="t12_red">*</span>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td id="div_area" align="left">
                                                    <%=addr.SelectAddress("div_area", "Purchase_State", "Purchase_City", "Purchase_County", spinfo.Purchase_State,spinfo.Purchase_City,spinfo.Purchase_County)%>
                                                </td>
                                                <td align="left">
                                                    <input name="Purchase_Address" type="text" id="Purchase_Address" class="txt_border"
                                                        size="40" maxlength="100" value="<%=spinfo.Purchase_Address %>" />
                                                    <span class="t12_red">*</span>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input type="text" class="input_calendar" name="Purchase_ValidDate" id="Purchase_ValidDate"
                                            maxlength="10" readonly="readonly" value="<%=spinfo.Purchase_ValidDate.ToString("yyyy-MM-dd") %>" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input name="Purchase_Attachment" id="Purchase_Attachment" class="txt_border" size="40"
                                            type="text" value="<%=spinfo.Purchase_Attachment %>" readonly="readonly" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" style="line-height: 24px;" class="t12_53">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <textarea cols="80" id="Purchase_Intro" name="Purchase_Intro" rows="16"><%=spinfo.Purchase_Intro %></textarea>
                                        <script type="text/javascript">
                                       ...
                                       foreach (SupplierPurchaseDetailInfo entity in entitys)
                                       {
                                        ...
                                        <table width="100%" border="0" cellspacing="5" cellpadding="5">
                                            ...
                                            <tr>
                                                ...
                                                <td width="270">
                                                    <input type="text" class="txt_border" name="Detail_Name<%=i %>" id="Detail_Name<%=i %>"
                                                        value="<%=entity.Detail_Name %>" />
                                                    <span class="t12_red">*</span>
                                                </td>
                                                <td align="right" style="line-height: 24px;" width="100" class="t12_53">
                                                    规格/单位：
                                                ...
                                                <td>
                                                    <input type="text" class="txt_border" name="Detail_Spec<%=i %>" id="Detail_Spec<%=i %>"
                                                        value="<%=entity.Detail_Spec %>" />
                                                    <span class="t12_red">*</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="txt_border" name="Detail_Amount<%=i %>" id="Detail_Amount<%=i %>"
                                                        value="<%=entity.Detail_Amount %>" />
                                                    <span class="t12_red">*</span>
                                                </td>
                                                <td align="right" style="line-height: 24px;" class="t12_53">
                                                    采购单价：
                                                ...
                                                <td>
                                                    <input type="text" class="txt_border" name="Detail_Price<%=i %>" id="Detail_Price<%=i %>"
                                                        value="<%=entity.Detail_Price %>" />
                                                    <span class="t12_red">*</span>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="center">
                                      <input name="apply_id" type="hidden" id="apply_id" value="<%=apply_id %>" />
                                        <input name="action" type="hidden" id="action" value="shop_apply_edit" />
                                       <%-- <input name="btn_submit" type="image" src="/images/save.jpg" />--%>
                                           <%if (spinfo.Purchase_Status == 0 || spinfo.Purchase_Status == 1)
                                          { %>
                                         <input type="submit" class="buttonSkinA" value="保存草稿" onclick="this.form.action.value='shop_apply_edit';" />
                                         <%} %>
                                        <%if (spinfo.Purchase_Status == 0 || spinfo.Purchase_Status==3)
                                          { %>
                                          <input type="submit" class="buttonSkinA" value="发布"onclick="this.form.action.value='shop_apply_edit_1';" />
                                        <%} %>
                                    </td>
                                </tr>
                            </table>
