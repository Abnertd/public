...
<% 
    ...
    supplier.Supplier_Login_Check("/supplier/auction_Product_edit.aspx?ProductID=" + ProductID);
...
<head>
    ...
    <title><%="修改拍卖商品 - " + pub.SEO_TITLE()%></title>
...
<body>
    ...
    <div class="webwrap">
        <div class="content02" style="margin-bottom: 20px;">
            <div class="position">当前位置 > <a href="/supplier/index.aspx">我是卖家</a> > <a href="/supplier/auction_list.aspx">拍卖列表</a> ><span>修改拍卖商品</span></div>
            <div class="partd_1">
                <div class="pd_left">
                ...
                <div class="pd_right">
                    ...
                    <div class="blk02">
                        <h2>
                            <ul>
                                <li class="on">修改拍卖商品<img src="/images/icon15.jpg"></li>
                            </ul>
                        </h2>
                        ...
                        <div class="b02_main">
                            <ul style="width:850px;">
                                ...
                                <li><span><i>*</i>重新图片：</span><label><iframe id="iframe2" src="<% =Application["Upload_Server_URL"]%>/public/uploadify.aspx?App=BidProduct&formname=frm_bid&frmelement=Bid_Product_Img&rtvalue=1&rturl=<% =Application["Upload_Server_Return_WWW"]%>" width="100%" height="90" frameborder="0" scrolling="no"></iframe></label></li>
                                <div class="clear"></div>
                            ...
                            <input name="Bid_Product_ProductID" id="Bid_Product_ProductID" type="hidden" value="<%=entity.Bid_Product_ProductID %>"/>
                            </form>
                    </div>
                </div>
            </div>
