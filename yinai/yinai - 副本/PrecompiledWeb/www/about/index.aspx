...
<body>
    ...
    <div class="content" style="margin-top: 0;">
        <div class="content_main">
            <!--位置说明 开始-->
            <div class="position">当前位置 > <a href="/index.aspx">关于我们</a> > <strong><%=about_title%></strong></div>
            <!--位置说明 结束-->
            <div class="partk">
                <div class="pk_left">
                    <div class="blk26">
                        ...
                        <div class="b26_main">
                            <ul>
                                <%=cms.Help_About_Nav(sign)%>
                                <li style="cursor: pointer"><a href="/about/index_link.aspx" style="cursor: pointer;">友情链接</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
