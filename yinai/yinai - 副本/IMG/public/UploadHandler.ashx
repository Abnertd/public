...
public class UploadHandler : IHttpHandler 
{
    public void ProcessRequest(HttpContext context)
    {
        ...
        frmelement = context.Request["frmelement"];
        rtvalue = context.Request["rtvalue"];
        rturl = context.Request["rturl"];
        ...
        {
            context.Response.Redirect("uploadify.aspx?" + context.Request.QueryString.ToString());
        }
        ...
        string MD5_fileFullName = string.Empty;
        ...
        switch (app)
        {
            ...
            case "supplierproduct":
                ...
                return_result("success", path_http + fileFullName, app, formname, frmelement, rtvalue, rturl,context);
                break;
                #endregion
            case "productintro":
                #region 商品编辑框
            ...
            //    CreateMiniature(32, 32, path + "tmp_" + fileFullName, path + fileFullName);
            ...
            case "BidProduct":
                ...
                #endregion
            default:
                return_result("error", "error_invaildapp", app, formname, frmelement, rtvalue, rturl, context);
                break;
        }
    ...
    private void return_result(string msgtype, string msg, string app, string formname, string frmelement, string rtvalue, string rturl,HttpContext context)
    {
        context.Response.Write(rturl + "?msgtype=" + msgtype + "&msg=" + msg + "&app=" + app + "&formname=" + formname + "&frmelement=" + frmelement + "&rtvalue=" + rtvalue);
    }
