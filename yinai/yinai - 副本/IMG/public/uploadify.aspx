...
<head>
    ...
    <script type="text/javascript">
        function checkForm() {
            if (form1.Filedata.value.length == 0) {
                alert("请选择上传文件");
                return false;
            }
            else {
...
<body>
    <form enctype="multipart/form-data" id="form1" method="post" action="<% =actURL%>" onsubmit="return checkForm()">
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td>
                    <input type="file" id="Filedata" name="Filedata" value="未选择" /></td>
               
            </tr>
            <tr>
                 <td>
                    <input type="submit" id="submit" name="submit" value="上传" style="width: 40px;" /></td>
            </tr>
        </table>
    </form>
</body>
