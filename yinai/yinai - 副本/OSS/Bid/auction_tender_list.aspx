...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (keyword != "输入竞价单位搜索" && keyword != null)
        {
            keyword = keyword;
        }
        else
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
				<form action="auction_tender_list.aspx" method="post" name="frm_sch" id="frm_sch" >
				  <tr bgcolor="#F5F9FC" >
					...
					<span class="left_nav">搜索</span> 
					 ...
					 <input type="text" name="keyword" size="50" id="keyword" onfocus="if(this.value=='输入竞价单位搜索'){this.value='';}" value="<% =keyword %>"> <input type="submit" name="btn_sch" class="btn_01" id="btn_sch" value="搜索" /></td>
				  </tr>
				  </form>
				</table>
    </td></tr>
    <tr>
      <td class="content_content">
        ...
        <script type="text/javascript">
            jQuery("#list").jqGrid({
                url: 'bid_do.aspx?action=AuctionTenderlist&<%=ReqURL %>',
                datatype: "json",
                colNames: ['ID', '竞价公告','竞价单位', "竞价总金额", "竞价时间", "是否中标", "操作"],
                colModel: [
