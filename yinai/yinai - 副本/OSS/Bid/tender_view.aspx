...
<body>
    <div class="content_div">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
            <tr>
                <td class="content_title">报价详情</td>
            </tr>
            <tr>
                <td valign="top" height="31" class="opt_foot">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="opt_gap">&nbsp;</td>
                            <td class="opt_uncur" id="frm_opt_2"><%=Public.Page_ScriptOption("choose_opt(2,2);", "报价清单")%></td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cell_table" id="frm_optitem_2" style="display: none;">
                        <tr>
                          ...
                          <%--  <td class="cell_title" style="text-align:center;">品牌</td>--%>
                            ...
                            <td class="cell_title" style="text-align:center;">报价单价</td>
                            <%if(Tender_IsWin==1){ %>
                            <td class="cell_title" style="text-align:center;">报价商品</td>
                            <%} %>
                        </tr>
                        <%myApp.TenderProductList(Tender_BidID, TenderProducts, Tender_IsWin, 0); %>
                    </table>
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td align="right">
                <%if (myApp.CheckBid(Tender_BidID)) {%>
                <input name="save" type="button" class="bt_orange" id="save" value="中标" onclick="location = 'bid_do.aspx?action=winadd&BidID=<%=Tender_BidID%>&TenderID=<%=Tender_ID%>';"/>
                <%} %>
