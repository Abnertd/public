...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["EmailMemberInfo"] = new List<MemberInfo>();
...
function SelectMember(){
		window.open ("selectmember.aspx?timer=" + Math.random(), "运营支撑系统", "height=560, width=600, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, status=no,top=100,left=300")
	}
	function member_del(member_id){
	    $.ajax({
	        url: encodeURI("member_do.aspx?action=member_del&member_id="+ member_id +"&timer="+Math.random()),
		    type: "get", 
		    global: false, 
		    async: false,
		    dataType: "html",
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    ...
    <tr>
      ...
      <tr>
          ...
          <td class="cell_content"><div id="yhnr"><% =myApp.ShowMember()%></div>
