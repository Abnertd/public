...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">虚拟账户明细</td>
    </tr>
    <tr><td height="5"></td></tr>
    <tr><td>
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
				<form action="account_detail.aspx" method="post" name="frm_sch" id="frm_sch" >
				  <tr bgcolor="#F5F9FC" >
    ...
    <tr>
      <td class="content_content">
        ...
        <script type="text/javascript">
        jQuery("#list").jqGrid({
        url: 'coin_do.aspx?action=accountlist&keyword=<% =Server.UrlEncode(Request["keyword"])%>&date_start=<% =Request["date_start"]%>&date_end=<% =Request["date_end"]%>',
			datatype: "json",
            ...
            sortname: 'MemberAccountLogInfo.Account_Log_ID',
			sortorder: "desc",
			rowNum: GetrowNum(),
			rowList: GetrowList(), 
			pager: 'pager',
