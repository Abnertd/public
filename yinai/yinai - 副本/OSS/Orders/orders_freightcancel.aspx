...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((Orders_DeliveryStatus ==0 ||Orders_DeliveryStatus == 5) || Orders_Status != 1)
        {
            Public.Msg("error", "错误信息", "所选订单无法退货", false, "{back}");
        }
...
<div class="content_div">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content_table">
    <tr>
      <td class="content_title">订单[<%=Orders_SN%>]退货信息</td>
    </tr>
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <input name="button" type="submit" class="bt_orange" id="Submit1" value="保存" />
				<input name="action" type="hidden" id="action" value="cancel_freight" />
